  ...
  return isLoading ? (<Shimmer />) : (
    <div className="min-h-screen bg-white text-black flex flex-col items-center justify-center px-6 py-10 sm:px-8 sm:py-5 overflow-auto">
      <div className="text-center mb-6 max-w-4xl cursor-pointer animate-fade-in">
        <h1 className="w-full text-5xl font-extrabold mb-1 tracking-tight transition-all duration-300 hover:text-slate-800">Karan Kumar</h1>
        ...
        <div className="flex justify-center space-x-6 font-extrabold text-xl tracking-tight transition-all duration-300">
